...
test('no network APIs in hook or lib sources', () => {
  const files = ['hooks/collect.js', 'hooks/session-start.js', 'hooks/finalize.js', 'lib/hook.js', 'lib/ledger.js', 'lib/transcript.js', 'lib/waste.js', 'lib/attributor.js', 'lib/forecast.js', 'statusline/tab-statusline.js', 'bin/tab.js'];
